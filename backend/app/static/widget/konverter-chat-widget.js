...
`,k={message:'<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>',close:'<path d="M18 6 6 18M6 6l12 12"/>',mic:'<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2M12 19v3"/>',micOff:'<path d="M2 2l20 20M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V5a3 3 0 0 0-5.94-.6M19 10v2a7 7 0 0 1-.11 1.23M12 19v3M8 23h8"/>',send:'<path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/>',stop:'<rect width="14" height="14" x="5" y="5" rx="2"/>'};function y(c){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${c}</svg>`}function R(c){let i=c.apiBase.replace(/\/+$/,""),r=c.documentId,e=document.createElement("style");e.textContent=V,document.head.appendChild(e);let d=document.createElement("div");d.className="kcw-widget",document.body.appendChild(d);let a=document.createElement("button");a.type="button",a.className="kcw-fab",a.setAttribute("aria-label","Ask about this document"),a.innerHTML=y(k.message);let s=document.createElement("div");s.className="kcw-panel",s.hidden=!0,s.innerHTML=`
    <div class="kcw-head">
      ...
      <button type="button" class="kcw-close" aria-label="Close chat">${y(k.close)}</button>
    </div>
