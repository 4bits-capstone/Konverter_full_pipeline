...
const stages: Array<{ stage: Stage; label: string; description: string }> = [
  ...
  { stage: "review", label: "Review", description: "Resolve flagged items" },
  {
    stage: "metadata",
    label: "Metadata",
    description: "Confirm source details",
  },
    ...
    <header className="converter-header">
      <div className="converter-brand-band">
        <div className="converter-brand-inner">
          <Link
            className="converter-brand"
            to={converterStagePath("upload")}
            aria-label="Komosion Konverter AI home"
          >
          ...
          <div className="converter-brand-right">
            <span className="converter-product">
              <strong>
                Konverter{" "}
                <span className="converter-product-ai">
                  <span className="converter-product-dot" aria-hidden="true">
                    •
                  </span>{" "}
                  AI
                </span>
